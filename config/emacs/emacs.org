...
#+begin_src emacs-lisp
  ...
  (use-package tide
    ...
    (add-hook 'js2-mode-hook #'tulkdan/setup-tide-mode)
    :hook
    ((typescript-mode . tide-setup)
     (typescript-mode . tide-hg-identifier-mode)
     (before-save . tider-format-before-save)))
#+end_src
